...
vim.keymap.set("n", "<leader>q", ":wq!<CR>", { noremap = true, silent = true, desc = "Write & [Q]uit File" })

-- Quick Action
vim.api.nvim_set_keymap(
	"n", -- Normal mode
	"<leader>a", -- Key combination
	":lua vim.lsp.buf.code_action()<CR>", -- Command to trigger quick fix/code actions
	{ noremap = true, silent = true, desc = "Quick [A]ction" }
)
